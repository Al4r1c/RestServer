    ...
    class AbstractRessourceTest extends TestCase
    {
        ...
        public function testDoGetPourRecherche()
        {
            ...
            $this->assertEquals(404,
                $abstractRessource->doGet(array('resource', null), array('var1 => filter1'))->getStatusHttp());
        }
        ...
        public function testDoPutCreateOrUpdate()
        {
            ...
            $this->assertEquals(201,
                $abstractRessource->doPut(array('resource', 4), array('nom' => 'nouveauNom'))->getStatusHttp());
        }
        ...
        public function testDoPutCollection()
        {
            ...
            $this->assertEquals(200,
                $abstractRessource->doPut(array('resource', 4, 'newCollection'), array(50))->getStatusHttp());
        }
        ...
        public function testDoPutInCollection()
        {
            /** @var $abstractRessource AbstractRessource */
            $abstractRessource = $this->createMock('AbstractRessource',
                new MockArg('putInCollection', new ObjetReponse(200), array(4, 'newCollection', 30)));

            $this->assertEquals(200,
                $abstractRessource->doPut(array('resource', 4, 'newCollection', 30), array())->getStatusHttp());
        }
        ...
        public function testDoPostUpdate()
        {
            ...
            $this->assertEquals(200,
                $abstractRessource->doPost(array('resource', 5), array('adresse' => 'adresseddd'))->getStatusHttp());
        }
        ...
        public function testDoPostCreate()
        {
            ...
            $this->assertEquals(201,
                $abstractRessource->doPost(array('resource', null), array('nom' => 'named'))->getStatusHttp());
        }
