<?php
    ...
    class FichierChargementTest extends TestCase {
        ...
        public function testChargerXml() {
            ...
            $this->assertThat($chargeur->chargerFichier(vfsStream::url('testPath/fichier.xml')), $this->logicalAnd($this->logicalNot($this->isNull()), $this->isInstanceOf('Serveur\Lib\XMLParser\XMLParser')));
        }
