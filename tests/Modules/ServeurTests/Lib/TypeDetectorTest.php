<?php
    ...
    class TypeDetectorTest extends TestCase {
        ...
        private static $mimeFichier = array('bmp' => 'image/bmp', 'css' => 'text/css', 'csv' => 'text/x-comma-separated-values', 'html' => 'text/html', 'jpg' => 'image/jpeg', 'js' => 'application/javascript', 'php' => 'application/x-httpd-php', 'xhtml' => 'application/xhtml+xml', 'xml' => 'application/xml',);
