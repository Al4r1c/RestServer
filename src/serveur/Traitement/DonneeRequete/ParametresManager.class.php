...
class ParametresManager
{
     ...
     */
    public function addDonneesRequete($donneesRequete)
    {
        if (!$donneesRequete instanceof ChampRequete) {
            throw new ArgumentTypeException(
                1000, 500, __METHOD__, '\Serveur\Traitement\DonneeRequete\DonneeRequete', $donneesRequete
            );
        }
    ...
    /**
     * @param ChampRequete $tri
     * @throws ArgumentTypeException
     */
    public function addTri($tri)
    {
        if (!$tri instanceof ChampRequete) {
            throw new ArgumentTypeException(
                1000, 500, __METHOD__, '\Serveur\Traitement\DonneeRequete\DonneeRequete', $tri
            );
        }
    ...
    private function traiterNouveauChampRequete($clef, $uneCondition)
    {
        ...
        $this->addDonneesRequete($unChampRequete);
    }
